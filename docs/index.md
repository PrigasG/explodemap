...
under `paper/outputs/drag_helpers`. These helper maps are generated by
`paper/scripts/07_generate_drag_helpers.R` and now cover 26 U.S. state
cases: NJ, PA, OH, MI, KY, IL, ND, NC, VA, TN, GA, MN, CA, CO, TX, FL,
AZ, IN, MA, MO, NV, NY, OR, SC, UT, and WA. The helpers export
documented region-level display-offset CSVs for the publication and
pkgdown gallery workflow.
