...
%   FINAL-SHA       : 7-char SHA of the commit that matches the archive
% -----------------------------------------------------------------------
% SUBMISSION-REF: [to be assigned]
% ZENODO-DOI: 10.5281/zenodo.20402131
% FINAL-SHA: 0b62e4d  (tag v0.2.0 = 5948bb7; HEAD after paper edits will differ)
...
\noindent A citable, version-frozen archive of the repository is deposited at
Zenodo~\citep{zenodo_explodemap}. The DOI \texttt{10.5281/zenodo.20402131}
resolves to the exact source tree used to generate the figures, tables, and
metrics reported here; readers wishing to reproduce results should use the
archived version rather than the live repository branch.
