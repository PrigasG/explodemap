...
[`vignette("getting-started")`](https://prigasg.github.io/explodemap/dev/articles/getting-started.md).
...
| `stats` | Geometry statistics from [`compute_stats()`](https://prigasg.github.io/explodemap/dev/reference/compute_stats.md) |
...
[`vignette("reproducing-paper-examples")`](https://prigasg.github.io/explodemap/dev/articles/reproducing-paper-examples.md).
