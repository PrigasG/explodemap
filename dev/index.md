...
- generate three-level grouped layouts for national or multi-region
  displays using
  [`explode_grouped()`](https://prigasg.github.io/explodemap/dev/reference/explode_grouped.md)
- add interactive selected-area focus, labels, and information cards
  using
  [`focus_map()`](https://prigasg.github.io/explodemap/dev/reference/focus_map.md)
...
[`explode_sf()`](https://prigasg.github.io/explodemap/dev/reference/explode_sf.md).
