...
- [`explode_sf_with_lookup()`](https://prigasg.github.io/explodemap/dev/reference/explode_sf_with_lookup.md)
...
- [`layout_regions()`](https://prigasg.github.io/explodemap/dev/reference/layout_regions.md)
  : Compute region anchor positions for grouped layouts
- [`estimate_block_radii()`](https://prigasg.github.io/explodemap/dev/reference/estimate_block_radii.md)
...
- [`compute_stats()`](https://prigasg.github.io/explodemap/dev/reference/compute_stats.md)
  : Compute geometry statistics for parameter derivation
- [`derive_params()`](https://prigasg.github.io/explodemap/dev/reference/derive_params.md)
  : Derive displacement parameters from geometry statistics
- [`calibration_row()`](https://prigasg.github.io/explodemap/dev/reference/calibration_row.md)
...
- [`print(`*`<exploded_map>`*`)`](https://prigasg.github.io/explodemap/dev/reference/print.exploded_map.md)
...
- [`summary(`*`<exploded_map>`*`)`](https://prigasg.github.io/explodemap/dev/reference/summary.exploded_map.md)
  : Summary of an exploded_map object
- [`print(`*`<grouped_exploded_map>`*`)`](https://prigasg.github.io/explodemap/dev/reference/print.grouped_exploded_map.md)
  : Print a grouped_exploded_map object
- [`plot(`*`<grouped_exploded_map>`*`)`](https://prigasg.github.io/explodemap/dev/reference/plot.grouped_exploded_map.md)
  : Plot a grouped_exploded_map object
- [`summary(`*`<grouped_exploded_map>`*`)`](https://prigasg.github.io/explodemap/dev/reference/summary.grouped_exploded_map.md)
